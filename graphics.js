...
function copyCanvasContentsToClipboard(canvas, onDone, onError) {
	scaleCanvas(canvas, 0.5).toBlob(function (blob) {
...
function saveToFile() {
	const canvas = scaleCanvas(document.querySelector(".copyable"), 0.5);
...
function postToAPI(after) {
	...
	fetch("https://koan-tool.herokuapp.com/api/v1/boards", {
		method: "post",
...
$(document).ready(function () {
	...
	$("form").on("submit", function (e) {
		...
		let url = "https://koan-tool.herokuapp.com/api/v1/boards/" + id;
